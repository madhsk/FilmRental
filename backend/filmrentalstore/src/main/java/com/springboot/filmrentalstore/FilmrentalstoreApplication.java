...
public class FilmrentalstoreApplication {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable() // Disable CSRF protection
				...
				.requestMatchers(HttpMethod.POST, "/api/staff/create").permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/api/staff/alladdress").permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/api/stores/city/{city}").hasAnyRole("STAFF","ADMIN")
				.requestMatchers(HttpMethod.GET, "/api/stores/country/{country}").hasAnyRole("STAFF","ADMIN")
				...
				.requestMatchers(HttpMethod.GET, "/api/inventory/store/{id}").hasAnyRole("STAFF")
				.requestMatchers(HttpMethod.GET, "/api/inventory/film/{id}").hasAnyRole("STAFF")
				.requestMatchers(HttpMethod.GET, "/api/inventory/film/{filmId}/store/{storeId}").hasAnyRole("STAFF")
				...
				.requestMatchers(HttpMethod.GET,"/api/films/**").hasAnyRole("STAFF","ADMIN")
