...
public class StaffController {
    ...
    public ResponseEntity<List<StaffDTO>> findByLastName(@PathVariable String lastName) throws ResourceNotFoundException {
    ...
    public ResponseEntity<?> getAllAddress(){
    	List<AddressDTO> addressList = staffService.getAllAddress();
    	return new ResponseEntity<>(addressList,HttpStatus.OK);
    }
    
    @GetMapping("/firstname/{firstName}")
    public ResponseEntity<List<StaffDTO>> findByFirstName(@PathVariable String firstName) throws ResourceNotFoundException {
    ...
    public ResponseEntity<List<StaffDTO>> findByCity(@PathVariable String city) throws ResourceNotFoundException {
        List<StaffDTO> staffList = staffService.findByAddress_City_CityName(city);
        return new ResponseEntity<>(staffList, HttpStatus.OK);
    }

    @GetMapping("/country/{country}")
    public ResponseEntity<List<StaffDTO>> findByCountry(@PathVariable String country) throws ResourceNotFoundException {
        List<StaffDTO> staffList = staffService.findByAddress_City_Country_CountryName(country);
        return new ResponseEntity<>(staffList, HttpStatus.OK);
    }

    @GetMapping("/phone/{phone}")
    public ResponseEntity<List<StaffDTO>> findByPhoneNumber(@PathVariable String phone) throws ResourceNotFoundException {
    ...
    public ResponseEntity<StaffDTO> updatePhoneNumber(@PathVariable Long id, @RequestBody String phoneNumber)
            throws ResourceNotFoundException {
